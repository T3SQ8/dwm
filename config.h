...
static const char *fonts[]          = { "JetBrains Mono:size=10", "monospace:size=10", "JoyPixels:pixelsize=10:antialias=true:autohint=true" };
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_i,      incnmaster,     {.i = +1 } }, // Change layout division
	{ MODKEY,                       XK_d,      incnmaster,     {.i = -1 } }, // Change layout division
	{ MODKEY,                       XK_h,      setmfact,       {.f = -0.05} }, // Change window division
	{ MODKEY,                       XK_l,      setmfact,       {.f = +0.05} }, // Change window division
	{ MODKEY|ShiftMask,             XK_p,      togglecanfocusfloating,   {0} }, // Diallow focus for window
	{ MODKEY,                       XK_w,      zoom,           {0} }, // Make window master
	...
	{ MODKEY,                       XK_s,      togglefloating, {0} }, // Make window floating
	{ MODKEY,                       XK_p,      togglesticky,   {0} }, // Make window sticky
	...
	//{ MODKEY|ShiftMask,             XK_0,      setgaps,        {.i = 0  } }, // Disable gaps
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
